import { Bakat40DTO } from 'src/v1/bakat40/bakat40.dto';

export const bakat40Array: Bakat40DTO[] = [
  {
    id: 1,
    latin: '‘Adaalah',
    arab: 'العَدَالَة',
    ...
    lalai_deskripsi:
      'berbuat tidak adil atau berat sebelah dalam bersikap dan bertindak sehingga merugikan orang atau pihak lain',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'ketiadaan pengetahuan sehingga menganggap yang dilakukan adalah adil, tetapi sebenarnya yang dilakukannya bukanlah keadilan',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 5 },
    pernyataan:
      'Ketika menghadapi orang lain, aku tidak berat sebelah dalam bersikap, tidak memihak, bersikap tengah-tengah, adil, dan fair dalam “permainan”.',
  },
  {
    id: 2,
    latin: 'Amaanah',
    ...
    lalai_deskripsi:
      'perkataan dan perlakuan yang tidak sesuai dengan apa yang telah diamanahkan',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'menerima tugas dan menuruti perkataan dan perbuatan orang lain tanpa mempedulikan kebenarannya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 6 },
    pernyataan:
      'Aku senang jika diberi tugas atau tanggung jawab atau amanah, dan aku berusaha melaksanakannya dengan sebaik-baiknya.',
  },
  {
    id: 3,
    latin: 'Anaah',
    ...
    lalai_deskripsi:
      'keinginan untuk mendapatkan sesuatu sebelum tiba waktunya yang disebabkan oleh besarnya keinginannya terhadap sesuatu tersebut, seperti halnya orang yang memanen buah sebelum datang waktu panennya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'salah satu senjata iblis yang disematkan di hati hamba Allah untuk menimbulkan keraguan, baik dalam beribadah, muamalah, maupun lainnya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 6 },
    pernyataan:
      'Aku tidak tergesa-gesa ketika akan bertindak dan terlebih dahulu mempertimbangkan berbagai hal agar tidak terjadi kesalahan.',
  },
  {
    id: 4,
    latin: '‘Aziimah',
    ...
    lalai_deskripsi:
      'merasa berat dan lamban terhadap sesuatu, padahal memiliki kekuatan, karena tidak adanya keinginan untuk berbuat kebaikan',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'keinginan kuat terhadap sesuatu yang sebenarnya tidak dibutuhkannya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 1 },
    pernyataan:
      'Ketika akan melakukan suatu pekerjaan, aku memiliki tekad yang kuat untuk segera memulainya dan kadang seperti orang yang tidak sabaran.',
  },
  {
    id: 5,
    latin: 'Basyaasyah',
    ...
    lalai_deskripsi:
      'berwajah masam dalam bergaul sehingga membuat orang-orang tidak suka, takut, bahkan lari darinya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'kelemahan untuk mempertahankan sesuatu sehingga cenderung untuk direndahkan orang lain karena kurangnya ketegasan dalam bersikap',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 5 },
    pernyataan:
      'Aku senang beramah tamah dan tersenyum kepada orang lain, berkata lembut, dan senang memberikan penyambutan sebaik-baiknya.',
  },
  {
    id: 6,
    latin: 'Dzakaa’',
    ...
    lalai_deskripsi:
      'meyakini sesuatu yang bertentangan dengan hakikat yang sebenarnya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'mendewakan logika dan akal dalam menghukumi sesuatu sehingga tidak menerima kebenaran yang tidak dapat dilogika',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 2 },
    pernyataan:
      'Aku termasuk orang yang cepat dan mudah dalam memahami sesuatu yang dihadapkan kepadaku, seperti menghitung, menganalisa dll.',
  },
  {
    id: 7,
    latin: 'Fashaahah',
    ...
    lalai_deskripsi:
      'kesalahan berbicara yang berupa pengulangan bunyi, suku kata, atau kata-kata, sehingga menjadikan tidak fasih berbicara',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'berbantah-bantahan untuk saling menjatuhkan satu dengan lainnya dengan menyalahgunakan kefasihan berbahasa yang dimiliki',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 4 },
    pernyataan:
      'Aku mampu menjelaskan sesuatu yang rumit menjadi mudah dipahami meskipun dengan ungkapan yang sederhana, baik lisan maupun tulisan.',
  },
  {
    id: 8,
    latin: 'Firaasah',
    ...
    lalai_deskripsi:
      'keyakinan terhadap sesuatu yang bertentangan dengan hakikatnya, sehingga dapat menjadikan seseorang tidak mampu memahami kebenaran yang sangat jelas tanda-tandanya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'mengabarkan sesuatu tidak sesuai dengan yang sebenarnya, baik sengaja atau tidak, baik masa lalu atau masa mendatang',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 2 },
    pernyataan:
      'Aku memiliki firasat kuat sehingga mampu menduga sesuatu yang akan terjadi dengan memperhatikan tanda-tanda yang tampak.',
  },
  {
    id: 9,
    latin: 'Ghairah',
    ...
    lalai_deskripsi:
      'tidak ada kepedulian pada diri seorang laki-laki (dan juga perempuan) terhadap kemungkaran yang terjadi dalam keluarganya, lembaga, lingkungan masyarakat, atau lainnya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'mengharap hilangnya nikmat pada orang yang diiri dan berpindah kepada orang yang iri',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 4 },
    pernyataan:
      'Aku tidak senang jika ada yang menyaingiku, melanggar hakku, atau ada yang melanggar aturan dan kesepakatan yang telah ditetapkan.',
  },
  {
    id: 10,
    latin: 'Hayaa’',
    ...
    lalai_deskripsi:
      'kadang disebut juga ber “muka tebal”, yaitu tidak malu ketika melanggar syariat Allah',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'tekanan jiwa yang muncul karena adanya konflik dalam diri antara keinginan untuk menjadi unggul dan rasa takut karena merasa dirinya tidak memiliki kemampuan. Dengan kata lain dirinya merasa lebih rendah dari orang lain tetapi takut dianggap rendah',
    berlebihan_perbaikan:
    ...
    profesi:
      'Ahli Ilmu, Ilmuwan, Administrator, Laboran, Analis, Fisikawan, Operator, Akuntan, Detailer.',
    jurusan:
      'Administrasi, Apoteker, Analis Kesehatan, Teknik Kimia, Teknik Fisika, Matematika',
    bakat6: { id: 3 },
    pernyataan:
      'Aku merasa memiliki kekurangan dan merasa apa yang telah aku terima melebihi hakku sehingga menjadikan aku merasa malu.',
  },
  {
    id: 11,
    latin: 'Hikmah',
    ...
    lalai_deskripsi:
      'meyakini sesuatu yang tidak sesuai dengan keadaan sebenarnya, atau tidak mengetahui sesuatu yang sebenarnya',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Kadzib (الكَذِب) (dusta)',
    berlebihan_deskripsi:
      'mengabarkan tentang sesuatu peristiwa yang tidak sesuai dengan keadaan sebenarnya, hanya didasari prasangka saja',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 2 },
    pernyataan:
      'Aku senang memikirkan sesuatu secara mendalam sehingga aku mampu menemukan hikmah dari sesuatu (peristiwa) yang telah terjadi.',
  },
  {
    id: 12,
    latin: 'Hilm',
    ...
    lalai_deskripsi:
      'mendidihnya darah dalam hati untuk menahan orang yang mengganggunya atau untuk membalas dendam setelah mengganggunya',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (lemah)',
    berlebihan_deskripsi:
      'kelemahan untuk mempertahankan sesuatu yang seharusnya dipertahankan',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 6 },
    pernyataan:
      'Aku mampu menahan diri untuk tidak memarahi atau membalas orang yang bersalah meskipun aku mampu melakukannya, dan aku tetap santun.',
  },
  {
    id: 13,
    latin: 'Himmah',
    ...
    lalai_deskripsi:
      'sikap malas, lesu, lamban dalam meraih sesuatu, padahal sebelumnya bersungguh-sungguh, semangat, dan bergairah',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'keinginan kuat terhadap sesuatu yang kemungkinan kecil untuk dapat diraih',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 1 },
    pernyataan:
      'Aku memiliki rasa ingin tahu yang tinggi terhadap sesuatu sehingga aku memiliki gairah untuk meraih mimpi (cita-cita) yang tertinggi.',
  },
  {
    id: 14,
    latin: 'Husnuzhan',
    ...
    lalai_deskripsi:
      'memenuhi hati dengan prasangka buruk, sampai memenuhi juga lisannya dan anggota badannya',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Taqliid (التَّقْلِيْد) (fanatik buta)',
    berlebihan_deskripsi:
      'mengikuti dan mempercayai perkataan dan perbuatan orang lain tanpa mempedulikan kebenarannya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 2 },
    pernyataan:
      'Aku selalu berprasangka baik terhadap orang lain meskipun fakta yang aku ketahui mendukung kepada dugaan yang buruk.',
  },
  {
    id: 15,
    latin: '‘Iffah',
    ...
    lalai_deskripsi:
      'segala hal yang mengindikasikan pada wilayah keburukan, kemaksiatan, dan dosa yang keluar pada wilayah batas kewajaran, serta dipandang sangat hina oleh akal sehat manusia dan syariat Islam',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (lemah)',
    berlebihan_deskripsi:
      'ketundukan jiwa dikarenakan ketidakmampuan untuk mempertahankan sesuatu, sehingga merendahkan diri sendiri',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 3 },
    pernyataan:
      'Aku mampu menjaga diri sehingga aku sangat menyesal jika terlanjur melakukan suatu pelanggaran atau larangan karena menuruti hasratku.',
  },
  {
    id: 16,
    latin: 'Ihsaan',
    ...
    lalai_deskripsi:
      'perbuatan yang menjadikan sesuatu menjadi lebih buruk atau perbuatan yang merusak',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'membelanjakan atau melakukan sesuatu pada hal yang seharusnya tidak diperlukan, berlebihan dalam membelanjakan atau berperilaku',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 1 },
    pernyataan:
      'Aku memiliki sifat perfeksionis sehingga aku selalu ingin segala sesuatu harus sempurna dan lebih sempurna lagi, dan aku tidak ingin seadanya.',
  },
  {
    id: 17,
    latin: 'Itsaar',
    ...
    lalai_deskripsi:
      'menahan kepemilikan yang seharusnya tidak dicegah, menahan sesuatu yang seharusnya tidak ditahan, atau menahan sesuatu yang wajib',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (lemah)',
    berlebihan_deskripsi:
      'kelemahan jiwa dikarenakan ketidakmampuan untuk mempertahankan hak pribadinya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 6 },
    pernyataan:
      'Aku senang mendahulukan orang lain meskipun sebenarnya aku lebih membutuhkannya sehingga aku menjadi orang yang senang melayani.',
  },
  {
    id: 18,
    latin: '‘Izzah',
    ...
    lalai_deskripsi:
      'lemahnya jiwa sehingga tidak mampu mempertahankan prinsipnya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'karena gengsi dan egonya, sehingga menolak kebenaran dan merendahkan orang lain',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 1 },
    pernyataan:
      'Aku memiliki prinsip yang kujadikan sebagai harga diriku dan aku mampu mempertahankannya meskipun dalam tekanan yang sangat berat.',
  },
  {
    id: 19,
    latin: 'Juud',
    ...
    lalai_deskripsi:
      'menahan sesuatu yang seharusnya tidak ditahan bahkan yang seharusnya wajib dikeluarkan',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'mengeluarkan sesuatu pada hal-hal yang seharusnya tidak terlalu perlu dan berlebihan dalam membelanjakan sesuatu',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 4 },
    pernyataan:
      'Aku senang memberikan sesuatu tanpa diminta kepada siapapun dan aku tidak mengharap balasan atau ucapan terima kasih.',
  },
  {
    id: 20,
    ...
    lalai_deskripsi:
      'membocorkan rahasia orang yang memberikan kepercayaan kepadanya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'menahan sesuatu yang seharusnya tidak ditahan untuk dikabarkan',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 6 },
    pernyataan:
      'Aku mampu menahan diri untuk tidak menyebarkan kabar (yang bukan aib) karena aku anggap sebagai privasi bagi orang yang bersangkutan.',
  },
  {
    id: 21,
    latin: 'Mahabbah',
    ...
    lalai_deskripsi:
      'ketidaksukaan menjalin kedekatan dalam suatu hubungan sehingga mengakibatkan kerenggangan hubungan',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Taqliid (التَّقْلِيْد) (fanatik buta)',
    berlebihan_deskripsi:
      'mencintai, mengikuti dan mempercayai orang lain atau sesuatu tanpa mempedulikan kebenaran dan manfaatnya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 5 },
    pernyataan:
      'Aku senang memperdalam hubungan yang sudah terjalin, dengan memberikan kasih sayang secara khusus kepada yang bersangkutan.',
  },
  {
    id: 22,
    latin: 'Munaafasah',
    ...
    lalai_tulisan: 'Dzull (الذُّلّ) (lemah)',
    lalai_deskripsi:
      'tidak mampu untuk bangkit  atau ketakutan dalam menghadapi persaingan dalam kehidupan sehingga menjadi terpuruk',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'berbuat aniaya dan curang kepada orang atau pihak lain hanya karena ingin unggul dari yang lain',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 4 },
    pernyataan:
      'Aku senang bersaing, berlomba atau berkompetisi agar aku menjadi yang paling unggul dari yang lainnya.',
  },
  {
    id: 23,
    latin: 'Muzaah',
    ...
    lalai_deskripsi:
      'bersikap kaku dalam pergaulan sehingga dapat mengurangi keakraban',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'berkata dan berbuat untuk tujuan bermain-main, bukan untuk keseriusan, dengan mengejek sifat dan perilaku orang yang diejek',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 5 },
    pernyataan:
      'Aku senang bercanda dan mengungkapkan kata-kata jenaka sehingga suasana menjadi lebih ceria dan lebih akrab.',
  },
  {
    id: 24,
    latin: 'Nashiihah',
    ...
    lalai_deskripsi:
      'menjerumuskan dan membiarkan seseorang menjadi lebih buruk keadaannya. (Sebagaimana yang dilakukan iblis kepada Adam dan Hawa)',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'menakut-nakuti orang lain sehingga menjadi bosan, lari atau enggan terhadap sesuatu yang dinasehatkan',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 4 },
    pernyataan:
      'Aku senang memberikan motivasi atau dorongan, saran-saran atau nasehat kepada orang lain agar menjadi lebih baik.',
  },
  {
    id: 25,
    latin: 'Nasyaath',
    ...
    berlebihan_tulisan: 'Thama’ (الطَّمَع) (serakah)',
    berlebihan_deskripsi:
      'keinginan kuat untuk mendapatkan sesuatu yang sebenarnya tidak dibutuhkannya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 1 },
    pernyataan:
      'Aku selalu ingin menyelesaikan suatu pekerjaan yang sedang aku lakukan dengan penuh semangat dan kerja keras.',
  },
  {
    id: 26,
    latin: 'Nubl',
    ...
    lalai_deskripsi:
      'kebingungan dalam menghadapi masalah karena tidak mengetahui solusi atau jalan keluar yang harus ditempuhnya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'menipu orang lain dengan kemampuannya bersiasat yang tidak diketahui oleh orang lain',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 2 },
    pernyataan:
      'Ketika aku mengalami suatu kesulitan, aku dengan mudah menemukan  peluang-peluang yang dapat dijadikan sebagai solusinya.',
  },
  {
    id: 27,
    latin: 'Nushrah',
    ...
    lalai_deskripsi:
      'membiarkan, tidak peduli, tidak memelihara sesuatu yang seharusnya dipelihara',
    lalai_perbaikan:
    ...
    bakat6: { id: 4 },
    pernyataan:
      'Aku senang membantu orang lain yang mengalami kesusahan sampai  terlepas dari kesusahan tersebut.',
  },
  {
    id: 28,
    latin: "Qanaa'ah",
    ...
    lalai_deskripsi:
      'berkeinginan kuat untuk mendapatkan sesuatu yang sebenarnya tidak dibutuhkannya',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (lemah)',
    berlebihan_deskripsi:
      'ketidakmampuan untuk menuntut haknya, sehingga meyusahkan dirinya sendiri',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 3 },
    pernyataan:
      'Aku merasa cukup dengan apa yang telah aku miliki dan rela menerima apapun yang diberikan kepadaku.',
  },
  {
    id: 29,
    latin: 'Rahmah',
    ...
    lalai_deskripsi:
      'kejam, kurang belas kasih, tidak pengertian dan kurang hasrat untuk kebaikan',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Taqliid (التَّقْلِيْد) (fanatik buta)',
    berlebihan_deskripsi:
      'mengikuti dan menuruti perkataan dan perbuatan orang lain tanpa mempedulikan kebenarannya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 6 },
    pernyataan:
      'Aku mudah merasa kasihan dan bersimpati kepada orang yang mengalami kesusahan dan berkeinginan untuk memberikan yang terbaik kepadanya.',
  },
  {
    id: 30,
    latin: 'Rifq',
    ...
    lalai_deskripsi:
      'bersikap kasar kepada orang lain yang melakukan kekeliruan',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (lemah)',
    berlebihan_deskripsi:
      'kelemahan jiwa sehingga tidak mampu memperbaiki suatu kesalahan atau pelanggaran yang dilakukan oleh seseorang',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 5 },
    pernyataan:
      'Aku selalu mengambil sisi termudah dalam menyikapi semua urusan, sehingga aku selalu lemah lembut dalam berbuat maupun berkata.',
  },
  {
    id: 31,
    latin: 'Satr',
    ...
    lalai_deskripsi:
      'menyebarkan aib diri (mujaahir) dan orang lain yang seharusnya ditutupi',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (Lemah)',
    berlebihan_deskripsi:
      'kelemahan untuk mengatakan sesuatu yang seharusnya dikatakan, sehingga menyembunyikan ilmu yang seharusnya disampaikan',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 6 },
    pernyataan:
      'Aku mampu menutupi dan tidak menampakkan atau menceritakan aib diri sendiri atau orang lain.',
  },
  {
    id: 32,
    latin: 'Shabr',
    ...
    lalai_deskripsi:
      'tampaknya kegelisahan yang menjadikan seseorang bereaksi (menolak/membalas) perlakukan terhadap dirinya sehingga menimbulkan kerusakan yang lebih besar',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (lemah)',
    berlebihan_deskripsi:
      'kelemahan untuk mempertahankan dan mendapatkan hak yang seharusnya diambilnya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 6 },
    pernyataan:
      'Aku mampu menahan diri untuk tidak bereaksi dan sabar terhadap tekanan, kesulitan atau apapun yang menimpa diriku.',
  },
  {
    id: 33,
    latin: 'Shamt',
    ...
    lalai_tulisan: 'Ghiibah (الغِيْبَة) (menggunjing)',
    lalai_deskripsi:
      'membicarakan suatu hal pada diri seseorang, baik dengan perkataan, isyarat, atau menirukan, yang apabila dia mengetahuinya, maka dia tidak menyukainya',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'takut untuk berbicara yang seharusnya tidak perlu ditakuti',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 3 },
    pernyataan:
      'Aku cenderung banyak diam dan berbicara seperlunya, sehingga yang aku ucapkan hanya ucapan yang diperlukan saja.',
  },
  {
    id: 34,
    latin: 'Shidq',
    ...
    lalai_deskripsi:
      'mengabarkan dan berperilaku sesuatu yang tidak sesuai dengan yang sebenarnya',
    lalai_perbaikan:
    ...
    berlebihan_tulisan:
      'Ifsyaa’us sirr (إِفْشَاءُ السِّرّ) (membocorkan rahasia)',
    berlebihan_deskripsi:
      'membocorkan rahasia orang yang memberikan kepercayaan kepadanya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 3 },
    pernyataan:
      'Aku mudah menerima saran dan masukan serta berkata dan berbuat sesuai dengan apa yang sebenarnya.',
  },
  {
    id: 35,
    latin: 'Syajaa’ah',
    ...
    lalai_deskripsi:
      'takut terhadap sesuatu yang seharusnya tidak perlu ditakuti',
    lalai_perbaikan:
    ...
    berlebihan_deskripsi:
      'bertindak tanpa dipikirkan dan dinalar terlebih dahulu, dan tidak peduli dengan apa yang akan terjadi',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 4 },
    pernyataan:
      'Aku berani menghadapi orang secara langsung, untuk berbicara kepadanya, memerintah, mengatur, atau menguasainya.',
  },
  {
    id: 36,
    latin: "Ta'aawun",
    ...
    lalai_deskripsi:
      'berupa ketidakadilan dalam bermuamalah, seperti merampas hak orang lain, menindas, dll',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (lemah)',
    berlebihan_deskripsi:
      'ketundukan jiwa dikarenakan ketidakmampuan untuk mempertahankan sesuatu, sehingga menjadi tidak mandiri dan tergantung pada orang lain',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 5 },
    pernyataan:
      'Aku senang menjalin kerjasama dengan orang lain, berdamai, dan menghindari konflik, untuk mencapai tujuan bersama.',
  },
  {
    id: 37,
    latin: "Tawaadhu'",
    ...
    lalai_deskripsi:
      'melihat diri lebih besar dari orang lain, sehingga menolak kebenaran dan merendahkan orang lain, tidak menerima nasehat dan suka mencela kelemahan orang lain',
    lalai_perbaikan:
    ...
    berlebihan_tulisan: 'Dzull (الذُّلّ) (lemah)',
    berlebihan_deskripsi:
      'ketidakmampuan untuk mempertahankan dan menuntut sesuatu yang menjadi haknya, sehingga menjadi dihinakan',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 3 },
    pernyataan:
      'Aku tidak suka menampakkan atau ditampakkan kehebatanku meskipun aku memilikinya, sehingga ada orang lain yang menyebutku rendah hati.',
  },
  {
    id: 38,
    latin: 'Ulfah',
    ...
    berlebihan_tulisan: 'Taqliid (التَّقْلِيْد) (fanatik buta)',
    berlebihan_deskripsi:
      'mengikuti dan mempercayai perkataan dan perbuatan kebanyakan orang di kelompoknya tanpa mempedulikan kebenarannya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 5 },
    pernyataan:
      'Aku senang berkumpul dengan orang banyak dan berusaha menambah anggota perkumpulan sebanyak-banyaknya.',
  },
  {
    id: 39,
    latin: "Wafaa'",
    ...
    berlebihan_tulisan: 'Taqliid (التَّقْلِيْد) (fanatik buta)',
    berlebihan_deskripsi:
      'mengikuti, mempercayai, dan menyepakati perjanjian dengan pihak lain tanpa mempedulikan kerugian dan kebenarannya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 5 },
    pernyataan:
      'Aku memegang teguh janji yang telah disepakati bersama, meskipun posisiku sebagai pihak yang dicurangi.',
  },
  {
    id: 40,
    latin: 'Waqaar',
    ...
    berlebihan_deskripsi:
      'persepsi tentang tingginya derajat pribadinya, yang sebenarnya tidak layak dinisbatkan kepadanya',
    berlebihan_perbaikan:
    ...
    bakat6: { id: 1 },
    pernyataan:
      'Aku tampak tenang tapi tangguh, tidak banyak bicara tapi bisa memahamkan, tidak tergesa tapi mendahului dalam semua urusan.',
  },
];
